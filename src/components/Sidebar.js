...
function Sidebar() {
  return (
    <div className="flex flex-col w-64 h-full py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
      <h2 className="text-3xl font-semibold text-center text-gray-800 dark:text-white">
        {/* <img className="h-10 mx-auto " src="/images/LogoIcon.png" alt="icon" /> */}
      </h2>

      <div className="flex flex-col items-center mt-6 -mx-2">
        <img
          className="object-cover w-24 h-24 mx-2 rounded-full"
          src="/images/vwpolo.jpg"
          alt="avatar"
        />
