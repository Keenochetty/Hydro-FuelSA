...
function Section3() {
  return (
    <div>
      <section className="bg-white dark:bg-gray-900 border-b-2 border-gray-100">
        <div className="container px-6 py-10 mx-auto">
          <h1 className="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">
            <span className="underline decoration-blue-500">Electrolysis</span>
          </h1>

          <p className="mt-4 text-gray-500 xl:mt-6 dark:text-gray-300">L</p>
